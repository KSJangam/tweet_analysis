...
Here we will use the rtweet package to obtain a number of recent tweets that have the keyword "covid". We also created another tibble where we filter for comments with more than 10 likes.
...
sentiment %>% filter(favorite_count >10)
