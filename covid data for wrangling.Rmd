...
# The sentiment tends to be negative when have higher faviorte counts (from pandemic search)
...
# The sentiment tends to be negative when have higher faviorte counts (from covid search)
